                ...
                <div id="primary" class="column">
                    <div id="primary-content" class="article">
                        <div class="section">
                            ...
                            <figure id="" class="wp-caption alignright" style="width:300px"><a href="#"><img class="size-full" alt="" src="<?php echo get_template_directory_uri() ?>/timthumb.php?src=img/dummy/photo-<?php echo rand(1,14) ?>.jpg&amp;w=300"></a><figcaption id="" class="wp-caption-text">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</figcaption></figure>
                            ...
                            <figure id="" class="wp-caption alignleft" style="width:200px"><a href="#"><img class="size-full" alt="" src="<?php echo get_template_directory_uri() ?>/timthumb.php?src=img/dummy/sidebar-poster-1.jpg&amp;w=200"></a><figcaption id="" class="wp-caption-text">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</figcaption></figure>
